...
public class InvoiceController {
    ...
    public InvoiceController(GetInvoiceByOrder getInvoiceByOrder,
                             InvoiceRestDtoMapper mapper) {
    ...
    public ResponseEntity<InvoiceResponseDTO> getByOrder(@PathVariable Integer idOrder) {
        Invoice invoice = getInvoiceByOrder.handle(idOrder);
        return ResponseEntity.ok(mapper.toResponseDTO(invoice));
    }
}
