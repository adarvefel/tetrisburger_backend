...
class MenuCategoryControllerTest {
    ...
    @MockitoBean private CreateMenuCategory createMenuCategory;
    @MockitoBean private UpdateMenuCategory updateMenuCategory;
    @MockitoBean private DeleteMenuCategory deleteMenuCategory;
    @MockitoBean private GetMenuCategoryById getMenuCategoryById;
    @MockitoBean private ListMenuCategory listMenuCategory;
    @MockitoBean private MenuCategoryDtoMapper mapper;
    ...
    class SecurityTests {
        ...
        void adminEndpoint_shouldReturn403_whenRoleIsClient() throws Exception {
            mockMvc.perform(get("/api/menu-category/1"))
